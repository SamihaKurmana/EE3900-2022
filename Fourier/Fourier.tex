...
\vspace{3cm}
\title{Fourier Series}
\author{Kurmana Samiha\\BM20BTECH11007}
\maketitle
\tableofcontents
...
\solution The Python code \texttt{codes/1.1.py} plots $x(t)$ below.
\begin{figure}[!htp]
    \includegraphics[width=\columnwidth]{/home/samiha/Documents/Fourier/Figures/1.1.png}
    \caption{$x(t)$}
    \label{fig:xt}
\end{figure}
...
\solution The Python code \texttt{codes/2.3.py} verifies \eqref{eq:one-Z-real}.
\begin{figure}[!ht]
    \includegraphics[width=\columnwidth]{/home/samiha/Documents/Fourier/Figures/2.3.png}
...
\begin{figure}[!ht]
    \includegraphics[width=\columnwidth]{/home/samiha/Documents/Fourier/Figures/2.6.png}
...
\begin{figure}[!ht]
    \includegraphics[width=\columnwidth]{/home/samiha/Documents/Fourier/Figures/3.8.png}
...
\begin{figure}[!ht]
    \includegraphics[width=\columnwidth]{/home/samiha/Documents/Fourier/Figures/3.9.png}
...
\begin{figure}[!ht]
    \includegraphics[width=\columnwidth]{/home/samiha/Documents/Fourier/Figures/3.10.png}
...
\begin{figure}[!ht]
    \includegraphics[width=\columnwidth]{/home/samiha/Documents/Fourier/Figures/4.3.png}
...
\texttt{codes/5.1.py} plots the magnitude response for different 
values of $n$ as shown below.
\begin{figure}[!ht]
    \includegraphics[width=\columnwidth]{/home/samiha/Documents/Fourier/Figures/5.1.png}
...
\begin{figure}[!ht]
    \includegraphics[width=\columnwidth]{/home/samiha/Documents/Fourier/Figures/5.2.png}
    \caption{Chebyshev response for various $n$.}
    \label{fig:cheby-resp}
\end{figure}
\begin{figure}[!ht]
    \includegraphics[width=\columnwidth]{/home/samiha/Documents/Fourier/Figures/5.3.png}
